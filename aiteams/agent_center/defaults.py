    ...
    return [
        {
            ...
            "spec": {
                ...
                "provider_ref": "prov_mock_local",
                "model": "mock-plan",
                "temperature": 0.2,
                "memory_policy": "agent_private",
                "plugin_refs": ["plugin_research_kit_v1"],
        ...
        },
        {
            ...
            "spec": {
                ...
                "temperature": 0.2,
                "memory_policy": "agent_private",
                "plugin_refs": ["plugin_codebase_kit_v1"],
        ...
        {
            "id": "agt_implementation_engineer",
            ...
            "spec": {
                ...
                "temperature": 0.2,
                "memory_policy": "agent_private",
                "plugin_refs": ["plugin_terminal_kit_v1"],
        ...
        {
            "id": "agt_topic_researcher",
            "key": "topic_researcher",
            "name": "主题研究员",
            "role": "researcher",
        ...
        },
        {
            ...
            "spec": {
                ...
                "temperature": 0.2,
                "memory_policy": "agent_private",
                "plugin_refs": ["plugin_research_kit_v1", "plugin_qa_kit_v1"],
                "skills": ["总结", "综合", "决策建议"],
                "delegation_mode": "none",
...
def default_team_templates() -> list[dict[str, Any]]:
    return [
        {
            "id": "team_software_delivery",
            "key": "software_delivery_team",
            "name": "软件交付团队",
            ...
            "spec": {
                ...
                "agents": [
                    {"key": "planner", "name": "规划负责人", "agent_template_ref": "agt_strategy_planner"},
                    {"key": "architect", "name": "架构负责人", "agent_template_ref": "agt_solution_architect"},
                    {"key": "developer", "name": "交付工程师", "agent_template_ref": "agt_implementation_engineer"},
                    {"key": "reviewer", "name": "质量关卡", "agent_template_ref": "agt_quality_reviewer"},
                ],
                "flow": {
                    "nodes": [
                        {"id": "start", "type": "start"},
        ...
        {
            "id": "team_approval_delivery",
            "key": "approval_delivery_team",
            "name": "审批交付团队",
            "description": "带人工审批关卡的提案团队。",
            "spec": {
                "workspace_id": "local-workspace",
                "project_id": "default-project",
                "agents": [{"key": "planner", "name": "审批策划", "agent_template_ref": "agt_proposal_planner"}],
                "flow": {
                    "nodes": [
                        {"id": "start", "type": "start"},
        ...
        {
            "id": "team_research_parallel",
            "key": "research_parallel_team",
            "name": "并行研究团队",
            ...
            "spec": {
                ...
                "project_id": "default-project",
                "agents": [
                    {"key": "researcher", "name": "主题研究分支", "agent_template_ref": "agt_topic_researcher"},
                    {"key": "risk_analyst", "name": "风险研究分支", "agent_template_ref": "agt_risk_specialist"},
                    {"key": "synthesizer", "name": "综合汇总", "agent_template_ref": "agt_synthesis_lead"},
                ],
                "flow": {
                    "nodes": [
                        {"id": "start", "type": "start"},
